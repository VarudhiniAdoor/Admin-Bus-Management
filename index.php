...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">BMS</a>
    ...
    <section id="home">
        <div id="route-search-form">
            ...
            <p class="text-center">Welcome to Bus Management System. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                   The most important part of any trip is planning because if you plan well, you are sure to enjoy your trip better. And online bus bookings allow you just that. You can check for bus routes to your destination, compare prices with other nearby routes all within a few minutes and with just a few taps on your phone. You can also avail of immediate cancellation in case of a sudden change in plans, within a few seconds
MySafety Assurance: All the buses available on our platform are MySafety-assured with regular sanitization of the vehicle carried out after every trip, regular temperature checks done on passengers before boarding the bus, and the staff following all safety protocols.All the buses available on our platform follow stringent safety protocols and government-mandated social distancing guidelines, with the primary focus on customer safety.
...
Seats are allocated, keeping the social dist...
            ...
            <div id="contact-form">
                ...
                <form action="">
                    <div>
                        ...
                        <input type="text" value="BMS"  name="name" id="name">
                    </div>
                    <div>
                        <label for="email">Email Address</label>
                        <input type="email" value="bms@gmail.com" name="email" id="email">
                    </div>
                    <div>
                        <label for="Phone">Phone</label>
                        <textarea name="Phone" id="Phone" cols="20" rows="1">9999900000</textarea>
                    </div>
                    <div></div>
                </form>
            </div>
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Bus Management System|
                        </p>
        </footer>
    </div>
